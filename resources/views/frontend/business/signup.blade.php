    ...
    <body>
        ...
        <section class="form_b_sec">
            <div class="container">
                ...
                <div class="row m-0 justify-content-center py-4 py-lg-5">
                <form action="{{ route('business.signuppage.store') }}" method="POST"   enctype="multipart/form-data">
                        ...
                        <div class="div1" id="st2">
                            ...
                            <div class="did-floating-label-content">
                            <input class="did-floating-input @error('primary_phone') is-invalid @enderror" type="text" name="primary_phone" id="primary_phone" onblur="validatePhone(this.value)" value="@php
