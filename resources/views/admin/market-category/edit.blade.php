    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.market-cat.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category_id">
                                ...
                                @foreach ($categories as $index => $item)
                                    <option value="{{$item->id}}" {{ ($item->id == $targetCategory->category_id) ? 'selected' : '' }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="tile-footer">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <a class="btn btn-secondary" href="{{ route('admin.market-cat.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
                    </div>
                </form>
            </div>
        </div>
