        ...
        <div class="col-md-12">
            ...
            <div class="tile">
                <div class="row align-items-center justify-content-between mb-3">
                    <div class="col">
                        <ul>
                            <li class="active"><a href="{{ route('admin.pin.index') }}">All <span class="count">({{$pin->count()}})</span></a></li>
                            {{-- @php
                    ...
                    <div class="col-auto">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <button type="submit" class="btn btn-primary">Search PostCode</button>
                            </div>
                        </div>
                        </form>
                    </div>
                            ...
                            @foreach($pin as $key => $category)
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.pin.edit', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.pin.details', $category['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-eye"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.pincode.data.csv.store')}}" enctype="multipart/form-data" id="fileCsvUploadForm">
                        @csrf
